	...
	export default {
		data() {
			return {
				...
				int:1200,		//抵扣积分
				deduction:0,	//抵扣价格
				recinfo:{id:1,name:"liqiqiorz",head:"li",tel:"18737699710",address:{region:{"label":"广东省-深圳市-福田区","value":[18,2,1],"cityCode":"440304"},detailed:'深南大道1111号无名摩登大厦6楼A2'},isDefault:true}
